...
app.get("/users", (req, res) => {
  const q =
    "SELECT id, userstatus, type, firstName, lastName, email, position, date_of_birth, date_of_hire, employment_type, supervisor_id, qualification, work_location, salary, notes, phone, gender, nationality FROM MPD.users";
